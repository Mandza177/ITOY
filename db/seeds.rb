...
the_titanic = Toy.new(title: "The Titanic", description: "the longest Lego build", price: 150, address: "Brest", user: john)
...
bonsai = Toy.new(title: "Bonsaï", description: "There's a small tree", price: 30, address: "La Rochelle", user: marc)
...
the_poudlard_express = Toy.new(title: "the Poudlard Express", description: "Get your ticket to Poudlard", price: 120, address: "Toulouse", user: pierre)
